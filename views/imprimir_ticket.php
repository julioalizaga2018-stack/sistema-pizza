<?php
// views/imprimir_ticket.php (Parte 1 de 2 - Sincronizado con Cliente)
...
// 2. Extraemos los datos maestros de la comanda cobrada (🌟 INYECTAMOS p.cliente_nombre EN EL SELECT)
...
<!-- 🌟 NUEVO RÓTULO DESTACADO: Si la factura tiene un cliente, la timbramos con alta visibilidad en el papel -->
<?php if (!empty($pedidoInfo['cliente_nombre'])): ?>
    <div style="border: 2px solid #000000; padding: 5px; text-align: center; font-size: 14.5px; font-weight: 900; margin-bottom: 8px; text-transform: uppercase; letter-spacing: 0.3px;">

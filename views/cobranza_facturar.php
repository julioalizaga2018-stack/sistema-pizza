...
require_once __DIR__ . '/../models/ProveedorModelo.php'; // Para usar tu conexión PDO si es necesario
...
<head>
    ...
    <style>
        .cobro-layout { display: grid !important; grid-template-columns: 1fr; gap: 25px; margin-top: 20px; width: 100%; }
        .cobro-card { background: #ffffff; border-radius: 12px; box-shadow: 0 4px 15px rgba(27,67,50,0.05); padding: 25px; border-top: 4px solid var(--verde-claro, #52b788); }
        .cobro-card h3 { color: var(--verde-oscuro, #1b4332); font-size: 1.2rem; margin-bottom: 15px; border-bottom: 2px solid var(--verde-menta, #d8f3dc); padding-bottom: 8px; }
        .item-linea { display: flex; justify-content: space-between; padding: 8px 0; border-bottom: 1px dashed #e2e8f0; font-size: 14px; }
        .form-control-cobro { width: 100% !important; padding: 10px 12px !important; border: 2px solid #cbd5e1 !important; border-radius: 6px !important; font-size: 1.05rem !important; font-weight: bold !important; font-family: monospace !important; }
        .form-control-cobro:focus { outline: none !important; border-color: var(--verde-claro, #52b788) !important; }
        .pago-box { background: #f8fafc; border: 2px solid #e2e8f0; border-radius: 8px; padding: 12px; margin-bottom: 12px; }
        .pago-box.active { border-color: var(--verde-claro, #52b788); background: rgba(216, 243, 220, 0.1); }
        .banner-totales { background: #1b4332; color: #ffffff; padding: 15px; border-radius: 8px; font-family: monospace; font-size: 14px; margin-bottom: 20px; }
        .banner-totales div { display: flex; justify-content: space-between; margin-bottom: 4px; }
        .banner-cambio { padding: 12px; border-radius: 6px; text-align: center; font-size: 16px; font-weight: bold; margin-bottom: 20px; font-family: monospace; }
        .cambio-falta { background: #ffe3e3; color: #c92a2a; border: 1px solid #ffa8a8; }
        .cambio-ok { background: #ebfbee; color: #2b8a3e; border: 1px solid #96f2d7; }
        .btn-facturar { background: var(--verde-selva, #2d6a4f); color: #fff; border: none; padding: 15px; width: 100%; border-radius: 8px; font-weight: bold; font-size: 16px; text-transform: uppercase; cursor: pointer; transition: background 0.2s; }
        .btn-facturar:hover { background: var(--verde-oscuro, #1b4332); }
        @media (min-width: 992px) { .cobro-layout { grid-template-columns: 380px 1fr; align-items: start; } }
    </style>
</head>
<body>
    ...
    <main class="main-content">
        ...
        <div class="cobro-layout">
            ...
            <div class="cobro-card">
                ...
                <form action="<?php echo URL_BASE; ?>controllers/CobranzaController.php" method="POST" onsubmit="return validarEnvioCobro();">
                    ...
                    <div class="pago-box" id="box_tarjeta">
                        ...
                        <div style="display:grid; grid-template-columns: 1fr 1fr; gap:10px; margin-bottom:8px;">
                            ...
                            <select name="banco_tarjeta" class="form-control-cobro" style="font-family:inherit; font-size:13px;">
                    ...
                    <div class="pago-box" id="box_trans">
                        ...
                        <div style="display:grid; grid-template-columns: 1fr 1fr; gap:10px; margin-bottom:8px;">
                            ...
                            <select name="banco_trans" class="form-control-cobro" style="font-family:inherit; font-size:13px;">
...
function validarEnvioCobro() {
    ...
    return confirm("¿Confirmar cobro y cerrar comanda comercial?");
}

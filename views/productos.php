                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div style="display: flex; gap: 6px; flex-wrap: wrap; align-items: center;">
                                                ...
                                                <?php
                                                $badge_color = "#475569"; $badge_bg = "#f1f5f9"; $badge_text = "Desconocido";
                                                if (isset($p['area_produccion'])) {
                                                    switch ($p['area_produccion']) {
                                                        case 'horno': $badge_bg = "#fff4e6"; $badge_color = "#d9480f"; $badge_text = "🔥🔥 Horno"; break;
                                                        case 'cocina': $badge_bg = "#ebfbee"; $badge_color = "#2b8a3e"; $badge_text = "🍳🍳 Cocina"; break;
                                                        case 'bar': $badge_bg = "#e3f2fd"; $badge_color = "#0d47a1"; $badge_text = "🍹🍹 Bar"; break;
                                                        case 'despacho': $badge_bg = "#f3f0ff"; $badge_color = "#5f3dc4"; $badge_text = "📦📦 Despacho"; break;
                                                    }
                                                }
                                                ?>

...
<head>
    ...
    <style>
        ...
        .jungle-table { width: 100%; border-collapse: collapse; text-align: left; min-width: 750px; }
        ...
        .btn-compras-action { background-color: #3b82f6; color: #ffffff !important; display: inline-flex; align-items: center; justify-content: center; padding: 10px 16px; font-size: 0.85rem; font-weight: 700; text-transform: uppercase; border-radius: 6px; text-decoration: none; border: none; cursor: pointer; transition: all 0.2s ease; }
        .btn-compras-action:hover { background-color: #2563eb; transform: translateY(-1px); }
        ...
        .page-jungle-link.active { background: #3b82f6; color: #fff; border-color: #3b82f6; }
    </style>
</head>
<body>
                            ...
                            <?php foreach ($lista_compras as $c): ?>
                                <tr>
                                    ...
                                    <td style="text-align: center;">
                                        <button class="btn-compras-action" style="padding: 6px 10px; font-size: 11px; background: #64748b; cursor: pointer;" onclick="abrirModalAuditoriaCompra(<?php echo $c['id']; ?>, '<?php echo htmlspecialchars($c['numero_factura']); ?>');">👁️ Ver Detalle</button>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        <?php endif; ?>
